...
function compile(fields, options, config) {
  ...
  if (options.nestTables === true) {
    ...
    for (var _i = 0; _i < resultTablesArray.length; _i++) {
      parserFn("result[".concat(helpers.srcEscape(resultTablesArray[_i]), "] = {};"));
    }
  }
  ...
  for (var _i2 = 0; _i2 < fields.length; _i2++) {
    fieldName = helpers.srcEscape(fields[_i2].name);
    parserFn("// ".concat(fieldName, ": ").concat(typeNames[fields[_i2].columnType]));

    if (typeof options.nestTables === 'string') {
      lvalue = "result[".concat(helpers.srcEscape(fields[_i2].table + options.nestTables + fields[_i2].name), "]");
    } else if (options.nestTables === true) {
      lvalue = "result[".concat(helpers.srcEscape(fields[_i2].table), "][").concat(fieldName, "]");

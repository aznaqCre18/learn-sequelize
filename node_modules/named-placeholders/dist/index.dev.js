'use strict'; // based on code from Brian White @mscdex mariasql library - https://github.com/mscdex/node-mariasql/blob/master/lib/Client.js#L272-L332
...
function createCompiler(config) {
  ...
  if (_typeof(config.cache) === 'object') {
    cache = config.cache;
  }

...
!function (t, e) {
  ...
  function r(t) {
    ...
    for (45 === t.charCodeAt(0) && (f = -(e = 1)); e < o.length; e++) {
      s = 60 * s + l(o.charCodeAt(e));
    }

    for (e = 0; e < r.length; e++) {
      i /= 60, s += l(r.charCodeAt(e)) * i;
    }
  ...
  function y() {
    ...
    var n,
      ...
      for (n = 1; n < 48; n++) {
        (e = new v(new Date(o, n, 1))).offset !== r.offset && (t = g(r, e), i.push(t), i.push(new v(new Date(t.at + 6e4)))), r = e;
      }

      for (n = 0; n < 4; n++) {
        i.push(new v(new Date(o + n, 0, 1))), i.push(new v(new Date(o + n, 6, 1)));
      }
      ...
      for (e = 0; e < r; e++) {
        for (n in o = c[t[e].offset] || {}) {
          o.hasOwnProperty(n) && (i[n] = !0);
        }
      }

      for (e in i) {
        i.hasOwnProperty(e) && s.push(a[e]);
      }
  ...
  function S(t) {
    ...
    for ("string" == typeof t && (t = [t]), e = 0; e < t.length; e++) {
      r = O(n = (o = t[e].split("|"))[0]), s[r] = t[e], a[r] = n, w(r, o[2].split(" "));
    }
  }
  ...
  function j(t) {
    ...
    for ("string" == typeof t && (t = [t]), e = 0; e < t.length; e++) {
      o = O((n = t[e].split("|"))[0]), r = O(n[1]), f[o] = r, a[o] = n[0], f[r] = o, a[r] = n[1];
    }
  }
  ...
  (n < 2 || 2 == n && o < 6) && D("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + i.version + ". See momentjs.com"), d.prototype = {
    ...
    parse: function parse(t) {
      ...
      for (r = 0; r < u; r++) {
        if (e = s[r], n = s[r + 1], o = s[r ? r - 1 : r], e < n && T.moveAmbiguousForward ? e = n : o < e && T.moveInvalidForward && (e = o), i < f[r] - 6e4 * e) return s[r];
      }
  ...
  }, T.version = "0.5.34", T.dataVersion = "", T._zones = s, T._links = f, T._names = a, T._countries = u, T.add = S, T.link = j, T.load = function (t) {
    S(t.zones), j(t.links), function (t) {
      var e, n, o, r;
      if (t && t.length) for (e = 0; e < t.length; e++) {
        n = (r = t[e].split("|"))[0].toUpperCase(), o = r[1].split(" "), u[n] = new z(n, o);
      }
    ...
    for (t in a) {
      a.hasOwnProperty(t) && (s[t] || s[f[t]]) && a[t] && e.push(a[t]);
    }

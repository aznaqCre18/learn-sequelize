...
!function (c, M) {
  ...
  function B() {
    ...
    var a,
      ...
      for (a = 1; a < 48; a++) {
        (M = new t(new Date(A, a, 1))).offset !== o.offset && (c = L(o, M), b.push(c), b.push(new t(new Date(c.at + 6e4)))), o = M;
      }

      for (a = 0; a < 4; a++) {
        b.push(new t(new Date(A + a, 0, 1))), b.push(new t(new Date(A + a, 6, 1)));
      }
  ...
  function s(c) {
    ...
    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) {
      o = X(a = (A = c[M].split("|"))[0]), p[o] = c[M], z[o] = a, W(o, A[2].split(" "));
    }
  }
  ...
  function m(c, M) {
    ...
    var a,
        A = p[c];
    return A instanceof f ? A : "string" == typeof A ? (A = new f(A), p[c] = A) : n[c] && M !== m && (a = m(n[c], m)) ? ((A = p[c] = new f())._set(a), A.name = z[c], A) : null;
  }
  ...
  function T(c) {
    ...
    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) {
      A = X((a = c[M].split("|"))[0]), o = X(a[1]), n[A] = o, z[A] = a[0], n[o] = A, z[o] = a[1];
    }
  }
  ...
  function E(c) {
    s(c.zones), T(c.links), function (c) {
      ...
      if (c && c.length) for (M = 0; M < c.length; M++) {
        a = (o = c[M].split("|"))[0].toUpperCase(), A = o[1].split(" "), i[a] = new N(a, A);
      }
  ...
  (a < 2 || 2 == a && A < 6) && S("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + b.version + ". See momentjs.com"), f.prototype = {
    ...
    parse: function parse(c) {
      ...
      for (o = 0; o < i; o++) {
        if (M = p[o], a = p[o + 1], A = p[o ? o - 1 : o], M < a && C.moveAmbiguousForward ? M = a : A < M && C.moveInvalidForward && (M = A), b < n[o] - 6e4 * M) return p[o];
      }
  ...
  }, C.version = "0.5.34", C.dataVersion = "", C._zones = p, C._links = n, C._names = z, C._countries = i, C.add = s, C.link = T, C.load = E, C.zone = m, C.zoneExists = function c(M) {

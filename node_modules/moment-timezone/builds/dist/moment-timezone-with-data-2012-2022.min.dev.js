...
!function (a, i) {
  ...
  function o(a) {
    ...
    for (45 === a.charCodeAt(0) && (n = -(i = 1)); i < r.length; i++) {
      A = 60 * A + m(r.charCodeAt(i));
    }

    for (i = 0; i < o.length; i++) {
      c /= 60, A += m(o.charCodeAt(i)) * c;
    }
  ...
  function P() {
    ...
    var e,
      ...
      for (e = 1; e < 48; e++) {
        (i = new b(new Date(r, e, 1))).offset !== o.offset && (a = E(o, i), c.push(a), c.push(new b(new Date(a.at + 6e4)))), o = i;
      }

      for (e = 0; e < 4; e++) {
        c.push(new b(new Date(r + e, 0, 1))), c.push(new b(new Date(r + e, 6, 1)));
      }
  ...
  function S(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      o = T(e = (r = a[i].split("|"))[0]), A[o] = a[i], s[o] = e, z(o, r[2].split(" "));
    }
  }
  ...
  function k(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      r = T((e = a[i].split("|"))[0]), o = T(e[1]), n[r] = o, s[r] = e[0], n[o] = r, s[o] = e[1];
    }
  }

  function C(a) {
    S(a.zones), k(a.links), function (a) {
      var i, e, r, o;
      if (a && a.length) for (i = 0; i < a.length; i++) {
        e = (o = a[i].split("|"))[0].toUpperCase(), r = o[1].split(" "), t[e] = new d(e, r);
      }
  ...
  (e < 2 || 2 == e && r < 6) && N("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + c.version + ". See momentjs.com"), M.prototype = {
    ...
    parse: function parse(a) {
      ...
      for (o = 0; o < t; o++) {
        if (i = A[o], e = A[o + 1], r = A[o ? o - 1 : o], i < e && G.moveAmbiguousForward ? i = e : r < i && G.moveInvalidForward && (i = r), c < n[o] - 6e4 * i) return A[o];
      }
  ...
  }, G.version = "0.5.34", G.dataVersion = "", G._zones = A, G._links = n, G._names = s, G._countries = t, G.add = S, G.link = k, G.load = C, G.zone = _, G.zoneExists = function a(i) {

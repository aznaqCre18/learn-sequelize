...
!function (a, i) {
  ...
  function g(a, i) {
    for (var e, r; r = 6e4 * ((i.at - a.at) / 12e4 | 0);) {
      (e = new d(new Date(a.at + r))).offset === a.offset ? a = e : i = e;
    }
  ...
  function P() {
    ...
    var e,
      ...
      for (e = 1; e < 48; e++) {
        (i = new d(new Date(r, e, 1))).offset !== o.offset && (a = g(o, i), c.push(a), c.push(new d(new Date(a.at + 6e4)))), o = i;
      }

      for (e = 0; e < 4; e++) {
        c.push(new d(new Date(r + e, 0, 1))), c.push(new d(new Date(r + e, 6, 1)));
      }
  ...
  function T(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      o = S(e = (r = a[i].split("|"))[0]), A[o] = a[i], s[o] = e, z(o, r[2].split(" "));
    }
  }
  ...
  function k(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      r = S((e = a[i].split("|"))[0]), o = S(e[1]), n[r] = o, s[r] = e[0], n[o] = r, s[o] = e[1];
    }
  }
  ...
  function B(a) {
    T(a.zones), k(a.links), function (a) {
      ...
      if (a && a.length) for (i = 0; i < a.length; i++) {
        e = (o = a[i].split("|"))[0].toUpperCase(), r = o[1].split(" "), t[e] = new b(e, r);
      }

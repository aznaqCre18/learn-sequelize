...
var isWindows = platform === 'win32'; // Unlinks on Windows are not atomic.
//
  ...
  _createClass(Unpack, [{
    ...
    value: function value(entry, fullyDone) {
      ...
      stream.on('error', function (er) {
        if (stream.fd) fs.close(stream.fd, function () {}); // flush all the data out so that we aren't left hanging

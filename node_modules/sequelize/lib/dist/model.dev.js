...
function () {
  ...
  _createClass(Model, [{
    ...
    value: function save(options) {
      ...
      return regeneratorRuntime.async(function save$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
                            ...
                            while (1) {
                              switch (_context2.prev = _context2.next) {
                                ...
                                case 6:
                                  ...
                                  if (!(include.association.through.model.rawAttributes[attr]._autoGenerated || attr === include.association.foreignKey || attr === include.association.otherKey || _typeof(instance[include.association.through.model.name][attr]) === void 0)) {
                                    _context2.next = 10;
                                    break;
                                  }
            ...
            case 81:
              _context4.prev = 81;
              _context4.t0 = _context4["catch"](77);
      ...
      }, null, this, [[77, 81, 85, 93], [86,, 88, 92]]);
    }
  }, {
    key: "reload",
    ...
    value: function update(values, options) {
      var changedBefore, setOptions, sideEffects, fields;
    ...
    value: function destroy(options) {
      var where, result, attributeName, attribute, defaultValue, currentValue, undefinedOrNull;
    ...
    value: function restore(options) {
      var deletedAtCol, deletedAtAttribute, deletedAtDefaultValue, result;
    ...
    value: function _assignOptions() {
      ...
      return this._baseMerge.apply(this, args.concat([this._mergeFunction]));
    }
  }, {
    ...
    value: function sync(options) {
      ...
      var attributes, rawAttributes, tableName, tableInfos, columns, foreignKeyReferences, removedConstraints, columnName, _columnName, currentAttribute, references, database, schema, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, foreignKeyReference, constraintName, indexes, _iteratorNormalCompletion7, _didIteratorError7, _iteratorError7, _iterator7, _step7, index;
      ...
      return regeneratorRuntime.async(function sync$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 64:
              _context12.prev = 64;
              _context12.t4 = _context12["catch"](50);
            ...
            case 82:
              indexes = _context12.sent;
              indexes = this._indexes.filter(function (item1) {
                return !indexes.some(function (item2) {
            ...
            case 98:
              _context12.prev = 98;
              _context12.t5 = _context12["catch"](87);
      ...
      }, null, this, [[50, 64, 68, 76], [69,, 71, 75], [87, 98, 102, 110], [103,, 105, 109]]);
    }
  }, {
    key: "drop",
    ...
    value: function findAll(options) {
      var tableNames, selectOptions, results;
    ...
    value: function upsert(values, options) {
      var createdAtAttr, updatedAtAttr, hasPrimary, instance, changed, updatedDataValues, insertValues, updateValues, now, field, _field, result, _result, record;
          ...
          switch (_context36.prev = _context36.next) {
            ...
            case 3:
              ...
              recursiveBulkCreate = function recursiveBulkCreate(instances2, options2) {
                ...
                return regeneratorRuntime.async(function recursiveBulkCreate$(_context35) {
                  while (1) {
                    switch (_context35.prev = _context35.next) {
                      ...
                      case 49:
                        _context35.prev = 49;
                        _context35.t0 = _context35["catch"](45);
                            ...
                            while (1) {
                              switch (_context34.prev = _context34.next) {
                                ...
                                case 63:
                                  ...
                                  if (!(include.association.through.model.rawAttributes[_attr2]._autoGenerated || _attr2 === include.association.foreignKey || _attr2 === include.association.otherKey || _typeof(associationInstance[include.association.through.model.name][_attr2]) === void 0)) {
                                    _context34.next = 67;
                                    break;
                                  }
                ...
                }, null, null, [[45, 49, 53, 61], [54,, 56, 60]]);
              };
    ...
    value: function destroy(options) {
      ...
      var instances, result, attrValueHash, deletedAtAttribute, field, where;
    ...
    value: function restore(options) {
      ...
      var instances, attrValueHash, deletedAtCol, deletedAtAttribute, deletedAtDefaultValue, result;
    ...
    value: function update(values, options) {
      ...
      var _i8, _Object$keys7, key, updatedAtAttr, valuesUse, build, attributes, instances, updateDoneRowByRow, changedValues, different, keys, result, affectedRows;

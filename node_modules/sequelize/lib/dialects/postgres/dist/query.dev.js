        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 13:
              ...
              if (_context.t0.code === "ECONNRESET" || /Unable to set non-blocking to true/i.test(_context.t0) || /SSL SYSCALL error: EOF detected/i.test(_context.t0) || /Local: Authentication failure/i.test(_context.t0)) {

...
function configure(gyp, argv, callback) {
  handle_gyp_opts(gyp, argv, function (err, result) {
    ...
    if (gyp.opts.ensure === false) {
      ...
      compile.run_gyp(install_args, result.opts, function (err2) {
        ...
        compile.run_gyp(['configure'].concat(final_args), result.opts, function (err3) {
      ...
      compile.run_gyp(['configure'].concat(final_args), result.opts, function (err4) {

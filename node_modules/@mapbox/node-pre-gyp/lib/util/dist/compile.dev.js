...
function which_node_gyp() {
  ...
  try {
    var node_gyp_main = require.resolve('node-gyp'); // eslint-disable-line node/no-missing-require
  ...
  if (process.execPath.indexOf('iojs') === -1) {
    try {
      var npm_main = require.resolve('npm'); // eslint-disable-line node/no-missing-require

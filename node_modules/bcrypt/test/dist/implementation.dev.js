...
var bcrypt = require('../bcrypt'); // some tests were adapted from https://github.com/riverrun/bcrypt_elixir/blob/master/test/base_test.exs
...
module.exports = {
  ...
  test_embedded_nulls: function test_embedded_nulls(assert) {

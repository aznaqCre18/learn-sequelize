...
var CLANG_FORMAT_START = process.env.CLANG_FORMAT_START || 'main';
...
function main(args) {
  ...
  var options = ['--binary=node_modules/.bin/clang-format', '--style=file'];
